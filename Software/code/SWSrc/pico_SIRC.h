...
#define DEFINEPICOSIRCH 1

#include "sirc.h"

class cPicoChannel_Exx; // opaque to all clients


class PICO_SIRC : public SIRC {
public:
	//Constructor for the class
	//Check error code with getLastError() to make certain constructor
	// succeeded fully.
	SIRC_DLL_LINKAGE __stdcall PICO_SIRC(int desiredInstance = -1, const char *configurationBitFile = NULL);

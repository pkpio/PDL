...
#define DEFINEPCIE2SIRCH 1

#include "sirc.h"

class PCIE2_SIRC : public SIRC {
public:
	//Constructor for the class
	//Check error code with getLastError() to make certain constructor
	// succeeded fully.
    SIRC_DLL_LINKAGE __stdcall PCIE2_SIRC(int desiredInstance = -1);

	//Destructor for the class
    __stdcall ~PCIE2_SIRC();
